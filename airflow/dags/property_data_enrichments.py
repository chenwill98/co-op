...
def refresh_analytics_views():
    ...
    logger.info("Refreshing underlying analytics percentiles view")
...
with DAG(
    ...
    # Step 2.5: Refresh analytics percentiles and tags materialized views
    refresh_analytics_views_task = PythonOperator(
        task_id='refresh_analytics_tags_view',
