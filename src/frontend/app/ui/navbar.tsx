...
export default function Navbar() {
  ...
  return (
    <div className="navbar sticky z-50 top-0 bg-base-100/80 backdrop-blur-lg border-b border-base-300/50 shadow-[0_4px_16px_rgba(0,0,0,0.04)] px-4 lg:px-8 py-3">
